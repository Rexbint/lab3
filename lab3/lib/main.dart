    ...
    return Scaffold(
      ...
      body: Center(
        child: ListView(
          ...
          children: <Widget>[
            Image.asset("images/TOMkD1jbHm4.jpg", fit: BoxFit.fill),
              ...
              child: Column(
                ...
                children: <Widget>[
                    Column(
                      ...
                      children: const <Widget>[
                        Text('Общежитие №20', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)) ,
                        Text('', style: TextStyle(fontSize: 8),),
                        Text('Краснодар, ул. Калинина, 13', style: TextStyle(fontSize: 15, color: Colors.grey),),
                      ],
                    ),
                  Row(
                    children: <Widget>[
                  IconButton(onPressed: likeReact, icon: Icon(Icons.favorite, color: likeState ?Colors.red[500] : Colors.grey[500],),),
                  Text('$likeCount'),
                    ],
                  ),
                  ],
                ...
                Row(
                  ...
                  children: <Widget> [
                    Column(
                      children: <Widget>[
                        IconButton(onPressed: () => launch("tel://+79189534060"), icon: Icon(Icons.call, color: Colors.green[500],),),
                        Text('ПОЗВОНИТЬ', style: TextStyle(color:Colors.green,),),
                      ],
                    ),
                    Column(
                      children: <Widget>[
                        IconButton(onPressed: () => launch('https://www.google.com/maps/search/?api=1&query=45.05030994296792,38.92070860447134'), 
                        icon: Icon(Icons.near_me, color: Colors.green[500],),),
                        Text('МАРШРУТ', style: TextStyle(color:Colors.green,),),
                      ],
                    ),
                    Column(
                      children: <Widget>[
                        IconButton(onPressed: () => Share.share('https://www.google.com/maps/search/?api=1&query=45.05030994296792,38.92070860447134'), 
                        icon: Icon(Icons.share, color: Colors.green[500],),),
